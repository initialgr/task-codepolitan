            ...
            <div class="list-group list-group-flush border-bottom scrollarea">
                <div class="list-group-item list-group-item-action py-3 lh-tight" aria-current="true">
                    ...
                    <div class="group-action">
                        ...
                        <a href="{{ url("/tasks/$item->id/delete") }}" class="badge bg-danger text-white"
                            onclick="event.preventDefault();
                            document.getElementById('{{ $item->id }}').submit();">Delete</a>
                        <form id="{{ $item->id }}" action="{{ url("/tasks/$item->id") }}" method="POST"
                            style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
